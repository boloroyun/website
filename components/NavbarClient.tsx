  ...
  return (
    <>
      ...
      <div className="bg-white shadow-sm">
        {/* Top contact bar */}
        <div className={`bg-gradient-to-r from-gray-900 to-gray-800 text-white transition-all duration-300 ${
          scrolled ? 'py-1 px-4' : 'py-2 px-4'
        }`}>
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4 text-xs sm:text-sm">
              ...
              >
                <Phone size={scrolled ? 12 : 14} className="mr-1" />
                <span className="hidden sm:inline">(571) 335-0118</span>
              ...
              <span className="hidden xl:inline text-gray-300">
                Sat: 10AM-3PM
              </span>
            </div>
            <div className="hidden sm:flex items-center space-x-2 lg:space-x-4 text-xs sm:text-sm">
              <Link
              ...
              <div className="hidden lg:flex items-center space-x-1 xl:space-x-2">
                ...
                >
                  <PinterestIcon size={scrolled ? 12 : 14} />
                </a>
                <a
                ...
                >
                  <TikTokIcon size={scrolled ? 12 : 14} />
                </a>
              </div>
            </div>
          </div>
        ...
        <nav
          className={`w-full bg-white transition-all duration-300 ${
            scrolled ? 'shadow-lg py-2' : 'shadow-sm py-3 sm:py-4'
          }`}
        >
                  ...
                  <div className="relative transform group-hover:scale-105 transition-transform duration-300">
                    <Image
                      ...
                      className={`transition-all duration-300 ${
                        scrolled 
                          ? 'h-12 sm:h-14 lg:h-16 w-auto scale-95' 
